...
const SMIDE_MACHINE_URL  = new URL('../fixtures/smide-machine.json', import.meta.url).href;
const SMIDE_SERVICES_URL = new URL('../fixtures/smide-services.js',  import.meta.url).href;
...
const BASELINE_URL = './test/baselines/smide-baseline.json';
